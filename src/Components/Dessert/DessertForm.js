    ...
    handleFieldChange = evt => {
     ...
     MakeNewDessert = evt => {
        ...
        userId: JSON.parse(sessionStorage.getItem("userInfo")).userId
            ...
            this.props.addDessert(dessert, "dessert").then(() => this.props.history.push("/desserts"))
        ...
        return (
           <React.Fragment>
              ...
              <form className="recipeForm">
                 ...
                 <button type="submit" onClick={this.MakeNewDessert} className="btn btn-primary">Submit</button>
              </form>
              </div>
           </React.Fragment>
        )
